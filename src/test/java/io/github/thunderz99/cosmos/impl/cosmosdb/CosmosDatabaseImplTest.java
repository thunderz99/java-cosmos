...
class CosmosDatabaseImplTest {
    ...
    void find_should_work_with_filter_comparing_null() throws Exception {
        ...
        try {
            ...
            // test = null(null will not be saved under cosmosdb, so used IS_DEFINED = false instead)
            {
    ...
    void bulkPatch_should_work_with_same_operations() throws Exception {
        ...
        try {
            db.bulkCreate(coll, dataList, partition);
    ...
    @Test
    void bulkPatch_should_validate_null_operations_before_copy() {
        var patchList = List.of(new BulkPatchOperation("bulkPatch_null_operations", null));

        assertThatThrownBy(() -> db.bulkPatch(coll, patchList, "Users"))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("operations should not be null");
    }
