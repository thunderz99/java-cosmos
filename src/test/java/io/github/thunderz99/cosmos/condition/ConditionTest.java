...
class ConditionTest {
	...
	public void buildQuerySpec_should_get_correct_SQL() {
        ...
        assertThat(params.get(1)).isEqualTo(new SqlParameter("@param001_id", List.of("id001", "id002", "id005")));
        assertThat(params.get(2)).isEqualTo(new SqlParameter("@param002_age", 30));
    }
	...
	public void buildQuerySpec_should_work_for_sub_cond_or() {
...

        {
            ...
            var params = List.copyOf(q.getParameters());
            assertThat(params.get(0)).isEqualTo(new SqlParameter("@param000_position", "leader"));
            assertThat(params.get(1)).isEqualTo(new SqlParameter("@param001_address", "London"));
        }
    }
	...
	public void buildQuerySpec_should_work_for_raw_cond() {
...

        {
            ...
            List<SqlParameter> params = Lists.newArrayList(new SqlParameter("@raw_param_status", "%enroll%"));
	...
	public void buildQuerySpec_should_work_for_LIKE() {
        ...
        assertThat(params.get(0)).isEqualTo(new SqlParameter("@param000_fullName__last", "Hanks"));
        assertThat(params.get(1)).isEqualTo(new SqlParameter("@param001_fullName__first", "%om%"));
        assertThat(params.get(2)).isEqualTo(new SqlParameter("@param002_age", 20));
    }
	...
	public void buildQuerySpec_should_work_for_ARRAY_CONTAINS_ANY() {
        ...
        assertThat(params.get(0)).isEqualTo(new SqlParameter("@param000_fullName__last", "Hanks"));
        assertThat(params.get(1)).isEqualTo(new SqlParameter("@param001_tags", List.of("id001", "id002", "id005")));
        assertThat(params.get(2)).isEqualTo(new SqlParameter("@param002_age", 20));
    }
	...
	public void buildQuerySpec_should_work_for_ARRAY_CONTAINS_ALL() {
        ...
        assertThat(params.get(0)).isEqualTo(new SqlParameter("@param000_fullName__last", "Hanks"));
        assertThat(params.get(1)).isEqualTo(new SqlParameter("@param001_tags__0", "id001"));
        assertThat(params.get(2)).isEqualTo(new SqlParameter("@param001_tags__1", "id002"));
        assertThat(params.get(3)).isEqualTo(new SqlParameter("@param002_age", 20));
    }
	...
	public void buildQuerySpec_should_work_for_aggregate() {
...

        {
            ...
            var params = List.copyOf(q.getParameters());
            assertThat(params).hasSize(1);
            assertThat(params.get(0)).isEqualTo(new SqlParameter("@param000_age", 20));
	...
	public void copy_should_work_for_rawsql() {
        ...
        }
        {
            ...
            var original = Condition.rawSql("SELECT * from c WHERE c.name = @param01 AND c.age > @param02", Lists.newArrayList(param1, param2));
	...
	public void buildQuerySpec_should_work_for_is_defined() {
        ...
        assertThat(params.get(0)).isEqualTo(new SqlParameter("@param000_id", "Hanks"));
        assertThat(params.get(1)).isEqualTo(new SqlParameter("@param001_age", true));
    }
	...
	public void negative_should_have_effect_for_a_condition_rawSql() {
        ...
        var filterQuery = Condition.rawSql("\"tokyo\" IN c.cities") //
                .not() // negative will have no effect for a whole rawSql
                .generateFilterQuery("", new ArrayList<>(), new AtomicInteger(), new AtomicInteger());
	...
	public void true_condition_in_subquery_should_work() {
        ...
        assertThat(params.get(0)).isEqualTo(new SqlParameter("@param000_id", "001"));
