...
class SubQueryExpressionTest {
    ...
    void buildArrayContainsAny_should_work() {
...

        {
            ...
            assertThat(param).isEqualTo(new SqlParameter("@items_009", List.of("id001", "id002", "id005")));
        }
...

        {
            ...
            assertThat(params).hasSize(1);
            var param = params.stream().collect(Collectors.toList()).get(0);
            assertThat(param).isEqualTo(new SqlParameter("@items_id_010", List.of("id001", "id002", "id005")));
...

        {
            ...
            assertThat(params).hasSize(1);
            var param = params.stream().collect(Collectors.toList()).get(0);
            assertThat(param).isEqualTo(new SqlParameter("@items_name_010", "react"));
    ...
    void buildArrayContainsAll_should_work() {
...

        {
            ...
            assertThat(ps.get(0)).isEqualTo(new SqlParameter("@items_009__0", "id001"));
            assertThat(ps.get(1)).isEqualTo(new SqlParameter("@items_009__1", "id002"));
        }
...

        {
            ...
            assertThat(params).hasSize(2);
            var ps = List.copyOf(params);
            assertThat(ps.get(0)).isEqualTo(new SqlParameter("@param001_tags__name__0", "react"));
            assertThat(ps.get(1)).isEqualTo(new SqlParameter("@param001_tags__name__1", "java"));
...

        {
            ...
            assertThat(params).hasSize(1);
            var ps = List.copyOf(params);
            assertThat(ps.get(0)).isEqualTo(new SqlParameter("@param001_tags__name", "react"));
    ...
    void toQuerySpec_should_work() throws Exception {

        {
            ...
            assertThat(param).isEqualTo(new SqlParameter("@param001_tags__name", List.of("react", "java")));
        }
