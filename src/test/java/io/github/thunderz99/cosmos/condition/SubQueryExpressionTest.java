...
class SubQueryExpressionTest {
    ...
    void buildArrayContainsAny_should_work() {
...

        {
            ...
            assertThat(params).hasSize(1);
            var param = params.stream().collect(Collectors.toList()).get(0);
            assertThat(param.toJson()).isEqualTo(new CosmosSqlParameter("@items_id_010", List.of("id001", "id002", "id005")).toJson());
...

        {
            ...
            assertThat(params).hasSize(1);
            var param = params.stream().collect(Collectors.toList()).get(0);
            assertThat(param.toJson()).isEqualTo(new CosmosSqlParameter("@items_name_010", "react").toJson());
    ...
    void buildArrayContainsAll_should_work() {
...

        {
            ...
            assertThat(ps.get(0).toJson()).isEqualTo(new CosmosSqlParameter("@items_009__0", "id001").toJson());
            assertThat(ps.get(1).toJson()).isEqualTo(new CosmosSqlParameter("@items_009__1", "id002").toJson());
        }
...

        {
            ...
            assertThat(params).hasSize(2);
            var ps = List.copyOf(params);
            assertThat(ps.get(0).toJson()).isEqualTo(new CosmosSqlParameter("@param001_tags__name__0", "react").toJson());
            assertThat(ps.get(1).toJson()).isEqualTo(new CosmosSqlParameter("@param001_tags__name__1", "java").toJson());
...

        {
            ...
            assertThat(params).hasSize(1);
            var ps = List.copyOf(params);
            assertThat(ps.get(0).toJson()).isEqualTo(new CosmosSqlParameter("@param001_tags__name", "react").toJson());
    ...
    void toQuerySpec_should_work() throws Exception {
        ...
        var selectAlias = "c";
        {
            ...
            assertThat(param.toJson()).isEqualTo(new CosmosSqlParameter("@param001_tags__name", List.of("react", "java")).toJson());
        }
