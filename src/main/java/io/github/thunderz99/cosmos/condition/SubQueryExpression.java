...
public class SubQueryExpression implements Expression {
     ...
     * </pre>
     */
    static String buildArrayContainsAny(String joinKey, String filterKey, String paramName, Object paramValue, List<SqlParameter> params) {
     ...
     * </pre>
     */
    static String buildArrayContainsAll(String joinKey, String filterKey, String paramName, Object paramValue, List<SqlParameter> params) {
